...
plan_me = cal_pos_abs(0.374, -0.023)
plan_2_me = cal_pos_abs(0.373, 0.023)
plan_3_me = cal_pos_abs(0.374, 0.067)
plan_4_me = cal_pos_abs(0.375, 0.112)
plan_5_me = cal_pos_abs(0.375, 0.156)
center_me = cal_pos_abs(0, 0)
max_level_me = cal_pos_abs(0.021, 0.234)
post_station_me = cal_pos_abs(-0.207, 0.066)
explore_me = cal_pos_abs(-0.081, 0.187)
map_switch_2_me = cal_pos_abs(0.45, 0.239)
iron_mine_me = cal_pos_abs(0.174, 0.134)
log_yard_me = cal_pos_abs(-0.01, 0.13)
farm_me = cal_pos_abs(-0.191, 0.127)
gold_mine_me = cal_pos_abs(0.352, 0.125)
queue_point_me = cal_pos_abs(-0.25, 0)
queue_point_me_2 = cal_pos_abs(-0.25, 0.05)
queue_point_me_3 = cal_pos_abs(-0.25, -0.05)
queue_point_me_4 = cal_pos_abs(-0.25, 0.1)
queue_point_me_5 = cal_pos_abs(-0.25, -0.1)
multi_select_me = cal_pos_abs(0.421, 0.246)